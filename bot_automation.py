...
class BotAutomation:
    ...
    def set_mode(self, mode: str) -> None:
        ...
        """
        if mode not in ['full_cycle', 'list_only']:
            raise ValueError(f"Invalid mode: {mode}. Must be 'full_cycle' or 'list_only'")
        ...
        if msg_data and msg_data.buttons:
            ...
            if self.state_machine.current_state == AutomationState.STEP_1:
                ...
                if msg_data and msg_data.buttons:
                    ...
                    # Check mode - if list_only, complete automation here
